...
class PlaceAdapter(private val items: MutableList<AreaBased.Response.Body.Items.Item>) : RecyclerView.Adapter<PlaceAdapter.ViewHolder>() {
    ...
    class ViewHolder(v: View) : RecyclerView.ViewHolder(v){
        ...
        fun bind(item: AreaBased.Response.Body.Items.Item){
